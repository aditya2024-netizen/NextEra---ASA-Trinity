      ...
      >
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold">
                  Why Is This Patient Classified {risk.riskLevel} Risk?
                </h3>
                <span
                  className={`px-2 py-0.5 rounded text-xs font-bold border ${badgeColor}`}
                >
                  {risk.score}/100
                </span>
              </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="p-4 rounded-lg bg-slate-50 border border-slate-200/80 flex flex-wrap items-center justify-between gap-3 text-xs">
            <div>
              <span className="text-slate-500 block font-bold uppercase tracking-wider text-[10px]">
                Patient Identity
              </span>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center text-xs">
              <span className="font-semibold text-slate-700">
                Follow-up Risk Position on Calibrated Scale
              </span>
              <span className="font-mono text-slate-500 text-[11px]">
                Thresholds: 0-29 Low | 30-59 Med | 60-100 High
              </span>
            </div>
            ...
            <div className="p-4 rounded-lg border border-red-200 bg-red-50/30 space-y-3">
              <div className="flex items-center gap-2 text-red-800">
                ...
                <h4 className="text-sm font-bold">
                  Risk-Increasing Drivers ({risk.reasons.length})
                </h4>
              </div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-16 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${factor.percentageContribution}%`,
                              }}
                            />
                          </div>
          ...
          <div className="p-4 rounded-lg bg-[#0F172A] text-slate-200 space-y-2 text-xs">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-blue-400 font-bold text-sm">
                ...
                Hybrid AI Comparison: Transparent Rule Engine vs. Logistic
            ...
            <p className="text-slate-300 leading-relaxed">
              CareTrack AI executes a primary deterministic, rule-based scoring
              engine for clinical explainability. Concurrently, a supervised
              Logistic Regression classifier evaluates non-linear multi-factor
              interactions:
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-1">
              <div className="bg-slate-800/80 p-2.5 rounded-lg border border-slate-700">
                <span className="text-slate-400 text-[11px] block">
                  Production Rule Score
                </span>
              ...
              <div className="bg-slate-800/80 p-2.5 rounded-lg border border-slate-700">
                ...
                <span className="text-base font-bold text-blue-400 font-mono">
                  {Math.round((risk.confidence ?? 0.8) * 100)}% (p ={" "}
                  {risk.confidence ?? 0.8})
                </span>
              </div>
